...
public final class RewriteBugs implements Runnable {
    ...
    public static List<?> calculateCartesianProduct(String[] names, Object[] values) {
        ...
        while (true) {
            ...
            binding = (HashMap<Object, Object>) binding.clone();
            int i = 0;
    ...
    public static Iterator<?> getIterator(Object collection) {
        if (collection == null) {
            ...
            final Enumeration<Object> eoc = (Enumeration<Object>) collection;
            ...
            return ((Map<Object, Object>) collection).values().iterator();
